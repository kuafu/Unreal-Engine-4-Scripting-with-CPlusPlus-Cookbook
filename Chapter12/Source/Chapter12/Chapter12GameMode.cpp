...
//D:\Program Files\Epic Games\UE_4.18\Engine\Source\Editor\LandscapeEditor\Public\LandscapeEditorUtils.h
...
AChapter12GameMode::AChapter12GameMode(const FObjectInitializer& PCIP) : Super(PCIP)
{
	...
	IGameplayTagsModule::Get().GetGameplayTagsManager().LoadGameplayTagTables(); //GameplayTagTableNames
	...
	const FFoliageInstance& Instance, UActorComponent* BaseComponent)
{
	...
	//AddInstance(InIFA, InSettings, InNewInstance, UActorComponent* InBaseComponent, bool RebuildFoliageTree)
...
//class UClass * ALandscape::GetPrivateStaticClass(void)
//{
//	return NULL;
//}
//
//class UClass * ULandscapeComponent::GetPrivateStaticClass(void)
//{
//	return NULL;
//}